...
from research_mcp.state_research_mcp import ResearcherState, ResearcherOutputState
...
# Initialize models
compress_model = init_chat_model(model="openai:gpt-5-mini", max_tokens=32000)
